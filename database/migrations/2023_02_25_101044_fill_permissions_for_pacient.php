...
class FillPermissionsForPacient extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPacient constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pacient',
            'admin.pacient.index',
            'admin.pacient.create',
            'admin.pacient.show',
            'admin.pacient.edit',
            'admin.pacient.delete',
            'admin.pacient.bulk-delete',
        ]);
